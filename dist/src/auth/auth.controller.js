...
let AuthController = class AuthController {
    ...
    async validateUserData(documentNumber, email) {
        if (!documentNumber && !email) {
            throw new common_1.BadRequestException('Email or document number is required');
        }
        const isAvailable = await this.authService.validateUserData(documentNumber, email);
        if (!isAvailable) {
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AuthController.prototype, "validateUserData", null);
